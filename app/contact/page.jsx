              ...
              {status==="success"?(
                ...
                <form onSubmit={handleSubmit}>
                  <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16}}>
                    <Input label="Name" name="name" required value={form.name} onChange={set("name")} placeholder="Alessandro Pracucci"/>
                    <Input label="Company" name="company" value={form.company} onChange={set("company")} placeholder="Levery S.r.l."/>
                  </div>
