  ...
  return(
    <div style={{fontFamily:"'Georgia',serif",background:C.sand,minHeight:"100vh",display:"flex",flexDirection:"column"}}>
      ...
      <div style={{flex:1,display:"flex",alignItems:"center",justifyContent:"center",flexDirection:"column",gap:24,padding:"100px 32px 64px"}}>
        <span style={{fontSize:10,fontFamily:"monospace",letterSpacing:"0.18em",color:C.inkLight,textTransform:"uppercase"}}>Impact</span>
        ...
        <p style={{fontSize:16,color:C.inkLight,fontFamily:"'Helvetica Neue',Arial,sans-serif",textAlign:"center",maxWidth:440,lineHeight:1.7,margin:0}}>Our impact as a Società Benefit — metrics, commitments and social goals. Coming soon.</p>
