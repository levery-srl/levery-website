      ...
      <nav style={{position:"fixed",top:0,left:0,right:0,zIndex:100,
        ...
        <div style={{maxWidth:1200,margin:"0 auto",padding:"0 32px",height:64,
          ...
          <ul style={{display:"flex",gap:28,listStyle:"none",margin:0,padding:0}} className="l-nav-links">
            {navLinks.map(([label,href])=>(
              <li key={label}><a href={href} style={{
                color:href==="/products"?"#fff":"rgba(255,255,255,0.72)",
                textDecoration:"none",fontSize:13,letterSpacing:"0.04em",
                fontFamily:"'Helvetica Neue',Arial,sans-serif",
                borderBottom:href==="/products"?"1px solid rgba(255,255,255,0.35)":"none",
                paddingBottom:2}}
                onMouseEnter={e=>e.target.style.color="#fff"}
                onMouseLeave={e=>e.target.style.color=href==="/products"?"#fff":"rgba(255,255,255,0.72)"}
              >{label}</a></li>
            ))}
          </ul>
          <div style={{display:"flex",gap:14,alignItems:"center"}}>
            ...
            <a href="/contact" style={{background:C.green,color:C.white,padding:"9px 20px",
      ...
      <footer style={{background:C.ink,padding:"56px 0 0"}}>
        <div style={{...inner,paddingBottom:48,
          ...
          <div>
            ...
            <p style={{fontSize:14,color:"rgba(255,255,255,0.3)",fontFamily:"'Georgia',serif",
              fontStyle:"italic",lineHeight:1.7,marginTop:14}}>{t.footerTagline}</p>
            <a href="/impact" style={{display:"inline-flex",alignItems:"center",gap:6,
          ...
          <div>
            ...
            {["Via Pisino 66, 47814 Bellaria Igea Marina (RN)","P.IVA 04730050400"].map((s,i)=>(
              <span key={i} style={{display:"block",fontSize:11,color:"rgba(255,255,255,0.2)",
